namespace Template {
    export async function skill1(): ƒS.SceneReturn {
        console.log("skill1");
        ...
        if(characters.Main.Skill1 == "Skystrike"){
            ...
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Hando, characters.Hando.pose.bowshot2, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Hando, characters.Hando.pose.bowshot3, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Hando, characters.Hando.pose.bowshot4, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Hando, characters.Hando.pose.bowshot5, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Hando, characters.Hando.pose.bowshot6, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.update(0.1);
            ...
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight2, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight3, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight4, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight5, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight6, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Liraz, characters.Liraz.pose.blindinglight7, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.update(0.1);
