namespace Template {
    export async function skill3funktion(): ƒS.SceneReturn {
        console.log("skill3");


        if(characters.Main.Skill3 == "Swordslash"){
            await ƒS.Character.show(characters.Adira, characters.Adira.pose.swordslash1, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Adira, characters.Adira.pose.swordslash2, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Adira, characters.Adira.pose.swordslash3, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Adira, characters.Adira.pose.swordslash4, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.Character.show(characters.Adira, characters.Adira.pose.swordslash5, ƒS.positionPercent(50, 90))
            await ƒS.update(0.1);
            await ƒS.Character.hideAll();
            await ƒS.update(0.1);
            
        }
        else if(characters.Main.Skill3 == "Rollshot"){
        ...
        else if(characters.Main.Skill3 == "Windburst"){
        ...
        else if(characters.Main.Skill3 == "Windstrike"){
